...
4. Add campaign duplicate flows with deterministic new keys/IDs, building on the guarded campaign action endpoint.
5. Add richer visual preview comparison for message versions, building on the path-based diff endpoint.
