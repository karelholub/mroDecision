...
6. Remove modal-heavy editor flows. Overview rule detail has been converted to an inline panel; Rule Builder, Message Editor, Reference Data Details, Evaluate payload, and publish review remain.
