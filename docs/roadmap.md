...
Status: started with experiment significance calculations, confidence labels, minimum-sample guidance, CSV export fields, a visual experiment variant builder with allocation controls and output fields, and plain-language branch condition summaries with schema-aware inline field hints. Remaining items are pending.

## Recommended Next Sprint

1. Add rule/message two-way linkage and real-time message preview improvements.
