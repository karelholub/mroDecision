...
7. Add adaptive multi-armed bandit experiments after fixed-split reporting and website feedback are stable. First-pass guarded server-side assignment, visual controls, freeze-to-winner support, recent assignment-history rollups, and hourly allocation trend charts are implemented; winner automation remains.
