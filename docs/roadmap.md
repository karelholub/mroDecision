...
7. Add adaptive multi-armed bandit experiments after fixed-split reporting and website feedback are stable. First-pass guarded server-side assignment, visual controls, freeze-to-winner support, and recent assignment-history rollups are implemented; deeper allocation trend charts and winner automation remain.
