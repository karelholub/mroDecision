...
7. Add adaptive multi-armed bandit experiments after fixed-split reporting and website feedback are stable. First-pass guarded server-side assignment is implemented; visual controls and allocation history remain.
